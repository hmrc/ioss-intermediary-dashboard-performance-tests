# ioss-intermediary-dashboard-performance-tests

Performance test suite for the `ioss-intermediary-dashboard-frontend`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
